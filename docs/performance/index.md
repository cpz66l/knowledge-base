...
| 项目实践 | [刷怪器与对象池](../projects/backpack-survivor/spawner-and-object-pooling.md)、[掉落系统](../projects/backpack-survivor/loot-drop-and-pity.md) | 预热、弹性扩容、掉落物复用和池化生命周期；Profiler 数据仍待补充 |
