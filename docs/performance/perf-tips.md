...
| 场景 / 坑 | 优化做法 |
|------|------|
| 纯装饰的 Image / Text 每帧参与射线检测 | 取消勾选 `Raycast Target`（详见 [Image](../unity/ugui/image.md)）|
...
| Legacy Text 渲染差、重建多 | 换 TextMeshPro（SDF 渲染，详见 [TextMeshPro](../unity/ugui/text-tmp.md)）|
