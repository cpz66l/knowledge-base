...
- 下一项改进：进入第 29 课武器稀有度与等级差异，并为合并升级收益、Tooltip、伤害数字格式、金币 HUD、背包价值、精英生成比例、宝箱品质分布、终局压力、DualWield、FireRateBoost、波次血量、宝箱距离 HUD、旋转邻接、15 分钟重复试玩、升级选择、倍率消费、波次切换、基础 HUD、战斗反馈资源接线、暂停恢复、结算重开和拖拽取消补齐可重复验证。
