...
>
> 新增证据：[主菜单与场景流](../projects/backpack-survivor/main-menu-and-scene-flow.md)记录了按钮事件镜像订阅、场景名加载、`Time.timeScale` 恢复和 Build Settings 配置复核。
>
