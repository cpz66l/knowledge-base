...
现有题解多数从 C# 笔记开始；以后每天提交的 C# 与 C++ 解法会合并到同一页面，不再为不同语言创建重复题解。
...
| 二叉树 | [查看规划](binary-tree.md) | DFS/BFS、前中后序、层序 |
...
当前共记录 23 道题，其中 4 道已经形成 C# / C++ 双语对照，并在题型索引中明确标记。

---

> 💡 每道题记录：题目链接、核心思路、C# 与 C++ 代码、时空复杂度、易错点和语言差异。缺少某种语言实现时如实保留，等实际练习后补充。
